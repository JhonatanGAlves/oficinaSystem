...
<body>
    ...
    <div class="container">
    	<form action="php/alt_fun.php" method="POST">
		    ...
		    <div class="form-group">
		    	<input type="text" name="nome_funcionario" id="nome_funcionario" value="<?=$row['nomeFuncionario'] ?>" autofocus class="form-control">
		    </div>
		    <br>
		    <div class="form-group">
		    	<input type="text" name="cpf_funcionario" maxlength="14" onkeypress="formatar('###.###.###-##', this)" value="<?=$row['identificacaoFuncionario'] ?>" autofocus class="form-control">
		    </div>
		    <br>
		    <div class="form-group">
		    	<input type="text" name="mao" id="mao" value="<?=$row['maoDeObraFuncionario'] ?>" autofocus class="form-control">
		    </div>
		    <input type="text" name="id_func" value="<?=$row['idFuncionario']?>" hidden>
		    <br>
		    <div align="center">
